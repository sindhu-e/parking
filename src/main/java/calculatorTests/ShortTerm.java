...
public class ShortTerm extends TestSuiteParent {
	
	private Logger logger;	
	
	@BeforeClass
	public void beforeClass() {			
	    logger  = LogManager.getFormatterLogger("ShortTerm");
	}
	
	@Test(dataProvider="getTestData",  dataProviderClass = CsvReader.class)
	//Input data file for Long term tests
	@CsvFileParameters(path = "src/main/resources/shortterm.csv")
	public void runTestCase(ParkingData data) {
		
		logger.info("Start Running Short term test");
